...
**congressapi** provides an extremely lightweight wrapper, facilitating seamless data retrieval from the [official Congress API](https://api.congress.gov/) via a single function, `congressGet()`.
...
Sys.setenv("CONGRESS_API_KEY" = "Q4sx4JhmbiXxePlys49UyztTbiUDkaRkERT3sPKW")
```
